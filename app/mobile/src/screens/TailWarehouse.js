...
const WarehouseList = [
{
    ...
    warehouse: ["paris", "lyon" , "marseille", "toulouse", "bordeaux", "nice", "nantes", "strasbourg",],
},
];

const App = () => {
const handleCompanySelection = (Warehouse) => {
...
return (
    ...
    <ScrollView>
        ...
        <View style={styles.etpContainer}>
            ...
            {WarehouseList[0].warehouse.map((Warehouse) => (
            <TouchableOpacity

                key={Warehouse}
                onPress={() => handleCompanySelection(Warehouse)}
